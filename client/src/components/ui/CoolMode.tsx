...
const applyParticleEffect = (
  ...
  const defaultParticle = "\images\paw.png"; // Ensure the image is placed in the public/images folder
  ...
  function generateParticle() {
    ...
    if (particleType === "circle") {
      ...
      particle.innerHTML = `<img src="/images/paw.png" width="${size}" height="${size}" style="border-radius: 50%">`;
    }

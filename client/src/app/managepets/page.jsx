...
const ManagePets = () => {
                        ...
                        petList.map(pet => {
                            return (
                                <tr key={pet._id} >
                                    ...
                                    <td className="size-px whitespace-nowrap">
                                        <div className="px-6 py-1.5">
                                            <button onClick={() => { deletePet(pet._id) }} className="text-sm text-white font-medium bg-red-600 rounded-lg px-3 py-1">
                                                Delete
                                            </button>
                                        </div>
                                    </td>
    ...
    return (
        <div className='max-w-[80%] mx-auto'>
            <h1 className='text-center font-bold text-3xl'>Manage Pets</h1>
            {displayPets()}
        </div>
    )
}
